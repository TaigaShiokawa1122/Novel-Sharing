 ...
 */
@WebServlet("/AdminNovelListByAuthorServlet")
public class AdminNovelListByAuthorServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		try {
			...
			request.getRequestDispatcher("/WEB-INF/admin-assets/admin-novel-list-by-author.jsp").forward(request, response);
